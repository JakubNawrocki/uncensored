  ...
  function() {
    function BehaviorSubject2(value) {
      ...
      this.then = function() {
        ...
        return (_a3 = _this2.toPromise()).then.apply(_a3, args);
      };
    }
...
var Animator = (
  ...
  function() {
    ...
    Animator2.prototype.warnElementNotPresent = function(id2) {
      console.warn("Cannot animate element: element with ID ".concat(id2, " not found!"));
    };
...
function parse$1(url) {
  ...
  if (pathOnly) {
    ...
    out.href = u.href;
    out.href = (_a3 = out.href) === null || _a3 === void 0 ? void 0 : _a3.slice(14);
  } else {
    u = new URL(url);
    out.href = u.href;
  ...
  function() {
    function Builder2(apiKey, request, response, forceNewInstance, authToken, apiVersion) {
      ...
      if (isBrowser) {
        ...
        var userAttrCookie = this.getCookie(Builder2.attributesCookieName);
        if (userAttrCookie) {
          try {
    ...
    Builder2.isTrustedHostForEvent = function(event2) {
      if (event2.origin === "null") {
        return false;
      }
      var url = parse(event2.origin);
      return url.hostname && Builder2.isTrustedHost(url.hostname);
    };
    ...
    Builder2.fields = function(name, fields) {
      var _a3;
      (_a3 = window.parent) === null || _a3 === void 0 ? void 0 : _a3.postMessage({
        type: "builder.fields",
        data: { name, fields }
    ...
    Builder2.serializeIncludingFunctions = function(info, isForPlugin) {
    ...
    Builder2.prepareComponentSpecToSend = function(spec) {
      return __assign(__assign({}, this.serializeIncludingFunctions(spec)), { class: void 0 });
    };
    ...
    Object.defineProperty(Builder2.prototype, "apiEndpoint", {
      get: function() {
    ...
    Builder2.prototype.findBuilderParent = function(target) {
      return this.findParentElement(target, function(el) {
        var id2 = el.getAttribute("builder-id") || el.id;
        return Boolean(id2 && id2.indexOf("builder-") === 0);
      });
    };
    ...
    Builder2.prototype.bindMessageListeners = function() {
      ...
      addEventListener("message", function(event2) {
        var _a3, _b2, _c, _d;
        var isTrusted2 = Builder2.isTrustedHostForEvent(event2);
        if (!isTrusted2)
          return;
        ...
        if (data2) {
          switch (data2.type) {
            ...
            case "builder.overrideTestGroup":
              var _e = data2.data, variationId = _e.variationId, contentId = _e.contentId;
    ...
    Builder2.prototype.getLocation = function() {
      ...
      var parsedLocation = {};
      if (this.request) {
        parsedLocation = parse((_a3 = this.request.url) !== null && _a3 !== void 0 ? _a3 : "");
    ...
    Builder2.prototype.setUserAttributes = function(options) {
      ...
      if (this.canTrack) {
        this.setCookie(Builder2.attributesCookieName, JSON.stringify(this.getUserAttributes()));
      }
    ...
    Builder2.prototype.get = function(modelName, options) {
      ...
      var instance = this;
      var finalLocale = options.locale || ((_a3 = options.userAttributes) === null || _a3 === void 0 ? void 0 : _a3.locale) || this.getUserAttributes().locale;
    ...
    Builder2.prototype.getSdkHeaders = function() {
      if (!Builder2.sdkInfo) {
        return {};
      }
      return {
        "X-Builder-SDK": Builder2.sdkInfo.name,
        "X-Builder-SDK-GEN": "1",
        "X-Builder-SDK-Version": Builder2.sdkInfo.version
      };
    };
    Builder2.prototype.addSdkHeaders = function(fetchOptions) {
      return __assign(__assign({}, fetchOptions), { headers: __assign(__assign({}, fetchOptions.headers), this.getSdkHeaders()) });
    };
    Builder2.prototype.makeFetchApiCall = function(url, requestOptions) {
      return getFetch()(url, this.addSdkHeaders(requestOptions));
    };
    Builder2.prototype.flattenMongoQuery = function(obj, _current, _res) {
      if (_res === void 0) {
        _res = {};
      }
      for (var key in obj) {
    ...
    Builder2.prototype.flushGetContentQueue = function(usePastQueue, useQueue) {
      ...
      var queryParams = __assign(__assign({
        ...
        omit: (_a3 = queue[0].omit) !== null && _a3 !== void 0 ? _a3 : "meta.componentsUsed",
        apiKey: this.apiKey
      ...
      var pageQueryParams = (typeof location !== "undefined" ? QueryString.parseDeep(location.search.substr(1)) : void 0) || {};
      var userAttributes = (
      ...
      if (this.preview && this.previewingModel === ((_b2 = queue === null || queue === void 0 ? void 0 : queue[0]) === null || _b2 === void 0 ? void 0 : _b2.model)) {
      ...
      var promise = this.makeFetchApiCall(url, fetchOptions).then(function(res) {
        ...
        for (var _i3 = 0, queue_3 = queue; _i3 < queue_3.length; _i3++) {
          ...
          var data2 = isApiCallForCodegenOrQuery ? result[keyName] : result.results;
          var sorted = data2;
          if (data2) {
    ...
    Builder2.prototype.processResultsForTests = function(results) {
      ...
      var mappedResults = results.map(function(item) {
        ...
        if (_this2.canTrack && item.variations && size(item.variations)) {
          ...
          for (var id2 in item.variations) {
            var variation = item.variations[id2];
    ...
    Builder2.prototype.getCookie = function(name) {
      if (this.cookies) {
        return this.cookies.get(name);
      }
      return Builder2.isBrowser && getCookie(name);
    };
    Builder2.prototype.setCookie = function(name, value, expires) {
      ...
      return Builder2.isBrowser && setCookie(name, value, expires);
    };
    ...
    Builder2.prototype.getAll = function(modelName, options) {
      ...
      var instance = this;
      if (!Builder2.isBrowser) {
        instance = new Builder2(options.apiKey || this.apiKey, options.req, options.res, false, options.authToken || this.authToken, options.apiVersion || this.apiVersion);
        instance.setUserAttributes(this.getUserAttributes());
      } else {
        if (options.apiKey && !this.apiKey) {
          this.apiKey = options.apiKey;
    ...
    Builder2.actions = [];
    Builder2.registry = {};
    Builder2.attributesCookieName = "builder.userAttributes";
...
var SDK_VERSION2 = "8.2.2";
var _a2;
"undefined" != typeof window && (null === (_a2 = window.parent) || void 0 === _a2 || _a2.postMessage({ type: "builder.isReactSdk", data: { value: true, supportsPatchUpdates: "v4", supportsCustomBreakpoints: true, supportsXSmallBreakpoint: true, supportsGlobalSymbols: true, blockLevelPersonalization: true, version: SDK_VERSION2 } }, "*"));
    ...
    return function(l) {
      return function(s3) {
        ...
        for (; o && (o = 0, s3[0] && (a = 0)), a; ) try {
          if (n = 1, i && (r = 2 & s3[0] ? i.return : s3[0] ? i.throw || ((r = i.return) && r.call(i), 0) : i.next) && !(r = r.call(i, s3[1])).done) return r;
          switch (i = 0, r && (s3 = [2 & s3[0], r.value]), s3[0]) {
            case 0:
            case 1:
              r = s3;
              break;
            ...
            case 7:
              ...
              continue;
            default:
              if (!(r = a.trys, (r = r.length > 0 && r[r.length - 1]) || 6 !== s3[0] && 2 !== s3[0])) {
                a = 0;
                continue;
              }
              if (3 === s3[0] && (!r || s3[1] > r[0] && s3[1] < r[3])) {
                a.label = s3[1];
                break;
              }
              if (6 === s3[0] && a.label < r[1]) {
                a.label = r[1], r = s3;
                break;
              }
              if (r && a.label < r[2]) {
                a.label = r[2], a.ops.push(s3);
                break;
              }
...
var sizes = { xsmall: { min: 0, default: 160, max: 320 }, small: { min: 321, default: 321, max: 640 }, medium: { min: 641, default: 642, max: 991 }, large: { min: 990, default: 991, max: 1200 }, getWidthForSize: function(e) {
...
var getSizesForBreakpoints = function(e) {
  var t = __assign2(__assign2({}, sizes), fastClone(sizes));
  if (!e) return t;
  var n = e.xsmall, i = e.small, r = e.medium;
  if (n) {
    var o = Math.floor(n / 2);
    t.xsmall = { max: n, min: o, default: o + 1 };
  }
  if (!i || !r) return t;
  var a = n ? t.xsmall.max + 1 : Math.floor(i / 2);
  t.small = { max: i, min: a, default: a + 1 };
  var s = t.small.max + 1;
  t.medium = { max: r, min: s, default: s + 1 };
  var l = t.medium.max + 1;
  return t.large = { max: 2e3, min: l, default: l + 1 }, t;
};
...
var safeDynamicRequire;
if ("function" == typeof (null === globalThis || void 0 === globalThis ? void 0 : globalThis.require) || Builder.isServer && "function" == typeof __require) try {
...
var shouldForceBrowserRuntimeInNode = function() {
  ...
  var t = "arm64" === process.arch, n = process.version.startsWith("v20"), i = null === (e = process.env.NODE_OPTIONS) || void 0 === e ? void 0 : e.includes("--no-node-snapshot");
...
function stringToFunction(e, t, n, i) {
  ...
  var l = function() {
    ...
    try {
      if (Builder.isBrowser || shouldForceBrowserRuntimeInNode()) return a.apply(void 0, t2);
      var r2 = getIsolateContext(), s2 = safeDynamicRequire("isolated-vm"), l2 = r2.evalClosureSync(makeFn(e, o), t2.map(function(e2, t3) {
        return "object" == typeof e2 ? new s2.Reference(t3 === indexOfBuilderInstance ? __assign2(__assign2({}, e2), { getUserAttributes: function() {
      ...
      return Builder.isBrowser ? console.warn("Builder custom code error:", t3.message || t3, "in", e, t3.stack || t3) : isDebug() && console.debug("Builder custom code error:", t3.message || t3, "in", e, t3.stack || t3), n && n.push(t3), null;
    }
  };
  return Builder.isBrowser && (fnCache[r] = l), l;
}
var indexOfBuilderInstance = 3;
var makeFn = function(e, t, n) {
  var i = n || ["state", "event", "block", "builder", "Device", "update", "Builder", "context"];
  return "\n".concat("\n  var refToProxy = (obj) => {\n    if (typeof obj !== 'object' || obj === null) {\n      return obj;\n    }\n    return new Proxy({}, {\n        get(target, key) {\n            if (key === 'copySync') {\n              return () => obj.copySync();\n            }\n            const val = obj.getSync(key);\n            if (typeof val?.copySync === 'function') {\n                return JSON.parse(stringify(val));\n            }\n            return val;\n        },\n        set(target, key, value) {\n            obj.setSync(key, value);\n        },\n        deleteProperty(target, key) {\n            obj.deleteSync(key);\n        }\n      })\n  }\n", "\n").concat("\n    var stringify = (val) => {\n      if (typeof val === 'object' && val !== null) {\n        return JSON.stringify(val.copySync ? val.copySync() : val);\n      }\n      return val;\n    }\n  ", "\n").concat(i.map(function(e2, t2) {
    return "var ".concat(e2, " = refToProxy($").concat(t2, ");");
  }).join("\n")).concat("\n".concat(i.includes("context") ? "var ctx = context;" : "", "\nvar endResult = function() {\n  ").concat(t ? "return (".concat(e, ");") : e, ";\n};\n\nreturn stringify(endResult());\n"));
};
var getIsolateContext = function() {
  var e = Builder.serverContext;
  e || (e = new (safeDynamicRequire("isolated-vm")).Isolate({ memoryLimit: 128 }).createContextSync(), Builder.setServerContext(e));
  var t = e.global;
  return t.setSync("global", t.derefInto()), t.setSync("log", function() {
    for (var e2 = [], t2 = 0; t2 < arguments.length; t2++) e2[t2] = arguments[t2];
    isDebug() && console.log.apply(console, e2);
  }), e;
};
...
var applyPatchWithMinimalMutationChain = function(e, t, n) {
  ...
  for (var s = n ? e : __assign2({}, e), l = s, u = 0; u < a.length; u++) {
    ...
    if (d) {
      ...
      l = l[c] = Array.isArray(m) ? __spreadArray([], m, true) : __assign2({}, m);
    }
  }
  return s;
};
...
function traverse(e, t, n, i, r) {
  void 0 === n && (n = null), void 0 === i && (i = null), void 0 === r && (r = /* @__PURE__ */ new WeakSet()), null != e && "object" == typeof e ? r.has(e) || (r.add(e), Array.isArray(e) ? e.forEach(function(n2, i2) {
    t(n2, function(t2) {
      e[i2] = t2;
    }), traverse(n2, t, e, i2, r);
...
var containsLocalizedValues = function(e) {
  if (!e || !Object.getOwnPropertyNames(e).length) return false;
  var t = false;
  return traverse(e, function(e2) {
    isLocalizedField(e2) && (t = true);
  }), t;
};
var extractLocalizedValues = function(e, t) {
  return e && Object.getOwnPropertyNames(e).length ? (traverse(e, function(e2, n) {
    var i;
    isLocalizedField(e2) && n(null !== (i = e2[t]) && void 0 !== i ? i : void 0);
  }), e) : {};
};
...
function deepCloneWithConditions(e) {
  ...
  if (Array.isArray(e)) return e.map(function(e2) {
    return deepCloneWithConditions(e2);
  });
  if ("@builder.io/sdk:Element" === e["@type"]) return e;
  var t = {};
  for (var n in e) "meta" !== n && Object.prototype.hasOwnProperty.call(e, n) && (t[n] = deepCloneWithConditions(e[n]));
  return t;
}
...
var BuilderBlock$1 = function(_super) {
  function BuilderBlock() {
    ...
    return _this.hydrated = false, _this.state = { hasError: false, updates: 0 }, _this.privateState = { state: {}, rootState: {}, context: {}, update: function() {
      ...
      if (message) switch (message.type) {
        case "builder.selectionChange":
          ...
          if (!data) break;
          var selection = data.selection, id = _this.block && _this.block.id;
        ...
        case "builder.patchUpdates":
          ...
          for (var _i = 0, patches_1 = patches; _i < patches_1.length; _i++) {
            ...
            applyPatchWithMinimalMutationChain(_this.props.block, patch, true);
          }
          _this.setState({ updates: _this.state.updates + 1 });
      }
    }, _this;
  }
  return __extends(BuilderBlock, _super), Object.defineProperty(BuilderBlock.prototype, "store", { get: function() {
    return this.privateState;
  }, enumerable: false, configurable: true }), BuilderBlock.getDerivedStateFromError = function(e) {
    ...
    return void 0 === t && (t = true), stringToFunction(e, t, this._errors, this._logs);
    ...
    var t, n, i, r, o, a, s, l, u = this.block, d = u.animations && u.animations[0];
    if (d && "hover" !== d.trigger) {
      var c = d && d.steps && d.steps[0], p = c && c.styles;
      p && (l = p);
    }
    var f = sizeNames.slice().reverse(), m = {};
    if (e) for (var h = Boolean(null === (i = null === (n = null === (t = this.privateState.context.builderContent) || void 0 === t ? void 0 : t.meta) || void 0 === n ? void 0 : n.breakpoints) || void 0 === i ? void 0 : i.xsmall), v = 0, g = f; v < g.length; v++) {
      var b = g[v];
      if (h || "xsmall" !== b) if ("large" === b) this.props.emailMode || (m["&.builder-block"] = Object.assign({}, e[b], l));
      else {
        var y = getSizesForBreakpoints((null === (o = null === (r = this.privateState.context.builderContent) || void 0 === r ? void 0 : r.meta) || void 0 === o ? void 0 : o.breakpoints) || {});
        m["@media only screen and (max-width: ".concat(y[b].max, "px)")] = { "&.builder-block": e[b] };
      }
    }
    var _ = u.animations && u.animations.find(function(e2) {
      return "hover" === e2.trigger;
    });
    return _ && (m[":hover"] = (null === (s = null === (a = _.steps) || void 0 === a ? void 0 : a[1]) || void 0 === s ? void 0 : s.styles) || {}, m.transition = "all ".concat(_.duration, "s ").concat(camelCaseToKebabCase2(_.easing)), _.delay && (m.transitionDelay = _.delay + "s")), m;
    ...
    if (Builder.isEditing && addEventListener("message", this.onWindowMessage), i) {
      ...
      Builder.animator.bindAnimations(r.animations.filter(function(e2) {
        return "hover" !== e2.trigger;
      }).map(function(e2) {
        return __assign2(__assign2({}, e2), { elementId: t.block.id });
      }));
    }
    ...
    if ("template" === p) {
      var f = c.children ? c.children.map(function(e2) {
        return blockToHtmlString(e2);
      }).join(" ") : "";
    ...
    c.component && !c.component.class && (c.component && c.component.tag ? d = c.component.tag : (h = Builder.components.find(function(e2) {
      return e2.name === m;
    ...
    var v = __assign2(__assign2({}, c.properties), { style: {}, responsiveStyles: fastClone(c.responsiveStyles || {}) });
    if (v = __assign2(__assign2({}, v.properties), v), c.component && (v.component = deepCloneWithConditions(c.component)), c.bindings) {
      for (var g in c.bindings) if (null === (i = g.trim) || void 0 === i ? void 0 : i.call(g)) {
        var b = this.stringToFunction(c.bindings[g]);
        set(v, g, b(t, null, c, api(), Device, null, Builder, this.privateState.context));
      }
    }
    if (v.hide) return null;
    if (delete v.hide, ("show" in v || c.bindings && c.bindings.show) && !v.show) return null;
    if (delete v.show, c.actions) {
      var y = function(e2) {
        if (!(null === (r = e2.trim) || void 0 === r ? void 0 : r.call(e2))) return "continue";
        var n2 = c.actions[e2];
        v["on" + capitalize(e2)] = function(e3) {
          var i2 = t;
          return "undefined" != typeof Proxy && (i2 = new Proxy(t, { set: function(e4, t2, n3) {
            return e4[t2] = n3, l.privateState.rootState[t2] = n3, true;
          } })), l.stringToFunction(n2, false)(i2, e3, l.block, builder, Device, l.privateState.update, Builder, l.privateState.context);
        };
      };
      for (var g in c.actions) y(g);
    }
    var _ = (v.component || v.options) && __assign2(__assign2({}, v.options), v.component.options || v.component.data);
    containsLocalizedValues(_) && (this.privateState.state.locale || console.warn("[Builder.io] In order to use localized fields in Builder, you must pass a locale prop to the BuilderComponent or to options object while fetching the content to resolve localized fields. Learn more: https://www.builder.io/c/docs/localization-inline#targeting-and-inline-localization"), _ = extractLocalizedValues(_, null !== (o = this.privateState.state.locale) && void 0 !== o ? o : "Default"));
    var S = voidElements.has(p), x = h && (h.fragment || h.noWrap), B = (null === (a = v.attr) || void 0 === a ? void 0 : a.style) || ("string" == typeof v.style ? v.style : "") || "";
    if ("string" == typeof B) {
      "object" != typeof v.style && (v.style = {});
      for (var k = 0, w = B.split(";"); k < w.length; k++) {
        var C = w[k].split(":");
        if (!C.length) return;
        g = C[0], b = C[1];
        g && (C.length > 2 && (b = C.slice(1).join(":")), v.style[kebabCaseToCamelCase(g)] = b);
      }
    }
    var E = __assign2(__assign2(__assign2({}, omit$1(v, ["class", "component", "attr", "responsiveStyles"])), ((n = {})["string" != typeof p || p.includes("-") ? "class" : "className"] = "builder-block ".concat(this.id).concat(c.class ? " ".concat(c.class) : "").concat(!c.component || ["Image", "Video", "Banner"].indexOf(m) > -1 ? "" : " builder-has-component") + (v.class ? " " + v.class : "") + (this.hydrated && Builder.isEditing && (null === (s = this.privateState.state._spacer) || void 0 === s ? void 0 : s.parent) === c.id ? " builder-spacer-parent" : ""), n.key = this.id + e, n["builder-id"] = this.id, n)), 0 !== e && { "builder-index": e });
    Builder.isEditing && this.hydrated && (E["builder-inline-styles"] = v.attr && v.attr.style ? Object.keys(v.style).reduce(function(e2, t2) {
      return (e2 ? "".concat(e2, ";") : "") + "".concat(cssCase(t2), ":").concat(v.style[t2], ";");
    }, "") : ""), (E.properties && E.properties.href || E.href) && "div" === p && (p = "a"), "a" === p && (p = Link);
    var R = c.children || E.children || [];
    return jsx(import_react3.default.Fragment, null, jsx(ClassNames, null, function(e2) {
      var t2 = e2.css;
      if (e2.cx, !l.props.emailMode) {
        var n2 = " " + t2(l.emotionCss(v.responsiveStyles));
        E.class && (E.class += n2), E.className && (E.className += n2);
      }
      return jsx(BuilderAsyncRequestsContext.Consumer, null, function(e3) {
        return l._asyncRequests = e3 && e3.requests, l._errors = e3 && e3.errors, l._logs = e3 && e3.logs, S ? jsx(p, __assign2({}, E)) : d && (x || l.props.emailMode) ? jsx(d, __assign2({}, _, { attributes: E, builderBlock: c, builderState: l.privateState })) : jsx(p, __assign2({}, E), d && jsx(d, __assign2({ builderState: l.privateState, builderBlock: c }, _)), c.text || v.text ? v.text : !d && R && Array.isArray(R) && R.length ? R.map(function(e4, t3) {
  ...
  }, Object.defineProperty(BuilderBlock.prototype, "id", { get: function() {
    var e = this.block;
    ...
    var t = this, n = this.block;
    if (this.privateState = e, n.repeat && n.repeat.collection) {
      var i = n.repeat.collection, r = last((i || "").trim().split("(")[0].trim().split(".")), o = n.repeat.itemName || (r ? r + "Item" : "item"), a = this.stringToFunction(i)(e.state, null, n, api(), Device, null, Builder, this.privateState.context);
      return Array.isArray(a) ? a.map(function(n2, i2) {
        var r2, a2 = __assign2(__assign2({}, e.state), ((r2 = { $index: i2, $item: n2 })[o] = n2, r2["$".concat(o, "Index")] = i2, r2));
        return jsx(BuilderStoreContext.Provider, { key: i2, value: __assign2(__assign2({}, e), { state: a2 }) }, t.getElement(i2, a2));
      }) : null;
    }
    return this.getElement();
  }, BuilderBlock.prototype.render = function() {
    var e = this;
    return this.state.hasError ? jsx("span", { css: { display: "inline-block", padding: 5, color: "#999", fontSize: 11, fontStyle: "italic" } }, "Builder block error :( Check console for details") : jsx(BuilderStoreContext.Consumer, null, function(t) {
      return e.contents(t);
    });
  }, BuilderBlock;
...
var BuilderBlocks = function(e) {
  function t() {
    ...
    return t2.hydrated = false, t2.onClickEmptyBlocks = function() {
      var e2;
...
var VariantsProvider = function(e) {
  var t = e.initialContent, n = e.children, i = e.nonce;
  if (Builder.isBrowser && !builder.canTrack) return n([t]);
  if (!Boolean(Object.keys((null == t ? void 0 : t.variations) || {}).length)) return n([t]);
  var r = Object.keys(t.variations).map(function(e2) {
    return __assign2(__assign2({ id: e2 }, t.variations[e2]), { data: getData(t.variations[e2]) });
  }), o = __spreadArray(__spreadArray([], r, true), [t], false);
  if (Builder.isServer) {
    var a = JSON.stringify(Object.keys(t.variations || {}).map(function(e2) {
      return { id: e2, testRatio: t.variations[e2].testRatio };
    }));
    return React.createElement(React.Fragment, null, n(o, function() {
      return React.createElement("script", { nonce: i, id: "variants-script-".concat(t.id), dangerouslySetInnerHTML: { __html: variantsScript(a, t.id) } });
    }));
  }
  var s = "builder.tests.".concat(t.id), l = builder.getCookie(s);
  if (!l && Builder.isBrowser) for (var u = 0, d = Math.random(), c = 0; c < r.length; c++) {
    var p = r[c];
    if (d < (u += p.testRatio)) {
      builder.setCookie(s, p.id), l = p.id;
      break;
    }
  }
  return l || (l = t.id, builder.setCookie(s, l)), n([o.find(function(e2) {
    return e2.id === l;
  })]);
};
var BuilderContent2 = function(_super) {
  function BuilderContent() {
    ...
    return _this.ref = null, _this.state = { loading: !_this.props.content, data: getContentWithInfo(_this.props.content), updates: 1 }, _this.onWindowMessage = function(event) {
      var _a, _b, isTrusted = Builder.isTrustedHostForEvent(event);
      if (isTrusted) {
        var message = event.data;
        if (message) switch (message.type) {
          case "builder.patchUpdates":
            ...
            _this.setState({ updates: _this.state.updates + 1, data: newData }), _this.props.contentLoaded && _this.props.contentLoaded(newData.data, newData);
        }
      }
  ...
  return __extends(BuilderContent, _super), Object.defineProperty(BuilderContent.prototype, "builder", { get: function() {
    ...
    var e, t;
    if (!this.props.inline || Builder.isEditing || Builder.isPreviewing) this.subscribeToContent();
    ...
    "_inline" !== this.name && this.subscriptions.add(this.builder.queueGetContent(this.name, this.options).subscribe(function(t) {
      ...
      if (!e.props.inline && e.props.content && e.firstLoad && i && (e.firstLoad = false, e.subscriptions.unsubscribe(), e.subscribeToContent()), n && e.firstLoad && (e.firstLoad = false, builder.autoTrack && !Builder.isEditing)) {
        var r = false;
        if ("function" == typeof IntersectionObserver && e.ref) try {
          ...
          })).observe(e.ref), r = true;
        } catch (e2) {
          console.warn("Could not bind intersection observer");
        }
        r || (e.trackedImpression = true, e.builder.trackImpression(n.id, e.renderedVariantId, void 0, { content: n }));
      }
    ...
    return import_react3.default.createElement(VariantsProvider, { initialContent: n, nonce: this.props.nonce }, function(r, o) {
...
var onChange_1 = createCommonjsModule(function(e, t) {
  ...
  var n = Symbol("target"), i = Symbol("unsubscribe"), r = function(e2, t2) {
    ...
    void 0 === a2 && (a2 = {});
    var s, l, u = Symbol("ProxyTarget"), d = false, c = false, p = false, f = a2.equals || Object.is, m = /* @__PURE__ */ new WeakMap(), h = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), g = function(e3, n2, i2, a3) {
      if (!p) if (d) {
      ...
      h.set(e3, t3);
      var n2 = v.get(e3);
      return void 0 === n2 && (n2 = new Proxy(e3, S), v.set(e3, n2)), n2;
    }, _ = function(e3) {
      ...
      return r2 || f(o2, n2) || g(h.get(e3), t3, o2, n2), a3;
    }, defineProperty: function(e3, t3, n2) {
      var i2 = Reflect.defineProperty(e3, t3, n2);
      return _(t3) || (b(e3, t3), g(h.get(e3), t3, void 0, n2.value)), i2;
      ...
      return n2 || (b(e3, t3), g(h.get(e3), t3, i2)), r2;
      ...
      if (i2 && (t3 = t3[u]), !d) {
        ...
        return d = false, (c || i2 && !f(l, t3.valueOf())) && (g(s, "", l, t3[u] || t3), l = null, c = false), r2;
      }
      return Reflect.apply(e3, t3, n2);
    } }, x = y(e2, "");
    return t2 = t2.bind(x), x;
  };
...
var tryEval = function(e, t, n) {
  ...
  if ("string" == typeof i && i.trim()) {
    ...
    try {
      ...
      var a = safeDynamicRequire("isolated-vm"), s = getIsolateContext(), l = makeFn(e, r, ["state"]), u = s.evalClosureSync(l, [new a.Reference(t || {})]);
      try {
        return JSON.parse(u);
      } catch (e2) {
        return u;
      ...
      n && n.push(t2), Builder.isBrowser ? console.warn("Builder custom code error:", t2.message, "in", e, t2.stack) : isDebug() && console.debug("Builder custom code error:", t2.message, "in", e, t2.stack);
    }
  }
};
function toError2(e) {
...
function getBuilderPixel(e) {
  return { id: "builder-pixel-" + Math.random().toString(36).split(".")[1], "@type": "@builder.io/sdk:Element", tagName: "img", properties: { role: "presentation", "aria-hidden": "true", src: "https://cdn.builder.io/api/v1/pixel?apiKey=".concat(e) }, responsiveStyles: { large: { height: "0", width: "0", display: "inline-block", opacity: "0", overflow: "hidden", pointerEvents: "none" } } };
}
function pick(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  var i = {};
...
var fetch$1;
globalThis.fetch && (fetch$1 = globalThis.fetch), null != fetch$1 || (fetch$1 = require_browser());
var sizeMap = { desktop: "large", tablet: "medium", mobile: "small", xsmall: "xsmall" };
var fetchCache = {};
...
var BuilderComponent2 = function(e) {
  function t(t2) {
    var n, i, r = this;
    (r = e.call(this, t2) || this).subscriptions = new Subscription(), r.onStateChange = new BehaviorSubject(null), r.asServer = Builder.isServer, r.contentRef = null, r.styleRef = null, r.rootState = Builder.isServer ? {} : onChange({}, function() {
      return r.updateState();
    }), r.lastJsCode = "", r.lastHttpRequests = {}, r.httpSubscriptionPerKey = {}, r.firstLoad = true, r.ref = null, r.messageListener = function(e2) {
      var t3;
      if (Builder.isTrustedHostForEvent(e2)) {
        var n2 = e2.data;
        switch (n2.type) {
          case "builder.configureSdk":
            var i2 = n2.data;
            if (!i2.contentId || i2.contentId !== (null === (t3 = r.useContent) || void 0 === t3 ? void 0 : t3.id)) return;
            r.sizes = getSizesForBreakpoints(i2.breakpoints || {}), r.setState({ state: Object.assign(r.rootState, { deviceSize: r.deviceSizeState, device: r.device }), updates: (r.state && r.state.updates || 0) + 1, breakpoints: i2.breakpoints });
            break;
          case "builder.updateSpacer":
            var o2 = n2.data;
            r.rootState._spacer, r.updateState(function(e3) {
              e3._spacer = o2;
            });
            break;
          case "builder.resetState":
            ...
            if (a2.model === r.name) {
              for (var l2 in r.rootState) "function" != typeof r.rootState[l2] && delete r.rootState[l2];
              Object.assign(r.rootState, s2), r.setState(__assign2(__assign2({}, r.state), { state: r.rootState, updates: (r.state && r.state.updates || 0) + 1 }));
            }
            break;
          case "builder.resetSymbolState":
            var u2 = n2.data.state, d = (s2 = u2.state, u2.model, u2.id);
            if (r.props.builderBlock && r.props.builderBlock === d) {
              for (var l2 in r.rootState) delete r.rootState[l2];
              Object.assign(r.rootState, s2), r.setState(__assign2(__assign2({}, r.state), { state: r.rootState, updates: (r.state && r.state.updates || 0) + 1 }));
            }
        }
      }
    }, r.resizeFn = function() {
      var e2 = r.deviceSizeState;
      e2 !== r.state.state.deviceSize && r.setState(__assign2(__assign2({}, r.state), { updates: (r.state && r.state.updates || 0) + 1, state: Object.assign(r.rootState, __assign2(__assign2({}, r.state.state), { deviceSize: e2 })) }));
    }, r.resizeListener = Builder.isEditing ? throttle2(r.resizeFn, 200) : debounce(r.resizeFn, 400), r.mounted = false, r.updateState = function(e2) {
      var t3 = r.rootState;
      e2 && e2(t3), r.mounted ? r.setState({ update: r.updateState, state: t3, updates: (r.state && r.state.updates || 0) + 1 }) : r.state = __assign2(__assign2({}, r.state), { update: r.updateState, state: t3, updates: (r.state && r.state.updates || 0) + 1 }), r.notifyStateChange();
    }, r.onContentLoaded = function(e2, t3) {
      if ("page" === r.name && Builder.isBrowser && e2) {
      ...
      if (Builder.isEditing && r.notifyStateChange(), r.props.contentLoaded && r.props.contentLoaded(e2, t3), e2 && e2.inputs && Array.isArray(e2.inputs) && e2.inputs.length && (e2.state || (e2.state = {}), e2.inputs.forEach(function(t4) {
        t4 && t4.name && void 0 !== t4.defaultValue && void 0 === e2.state[t4.name] && (e2.state[t4.name] = t4.defaultValue);
      })), e2 && e2.state) {
        var l2 = __assign2(__assign2({}, r.state), { updates: (r.state && r.state.updates || 0) + 1, state: Object.assign(r.rootState, __assign2(__assign2(__assign2(__assign2(__assign2({}, r.state.state), { location: r.locationState, device: r.device }), e2.state), r.externalState), { deviceSize: r.deviceSizeState })) });
        r.mounted ? r.setState(l2) : r.state = l2;
      }
      if (e2 && e2.jsCode && !r.options.codegen) {
        var u2 = false;
        if (Builder.isEditing && (r.lastJsCode === e2.jsCode ? u2 = true : r.lastJsCode = e2.jsCode), !u2) {
          var d = r.state.state;
          try {
            new Function("data", "ref", "state", "update", "element", "Builder", "builder", "context", e2.jsCode)(e2, r, d, r.state.update, r.ref, Builder, builder, r.state.context);
          } catch (t4) {
            var c = toError2(t4);
            Builder.isBrowser ? console.warn("Builder custom code error:", c.message, "in", e2.jsCode, c.stack) : isDebug() && console.debug("Builder custom code error:", c.message, "in", e2.jsCode, c.stack);
          }
        }
      }
      if (e2 && e2.httpRequests && !r.props.noAsync && !(u2 = false)) {
        var p = function(t4) {
          var n3 = e2.httpRequests[t4];
          if (n3 && (!r.data[t4] || Builder.isEditing)) {
            var i3 = "object" == typeof n3 && "@builder.io/core:Request" === n3["@type"];
            if (Builder.isBrowser) {
              var o3 = i3 ? r.evalExpression(n3.request.url) : r.evalExpression(n3);
              if (Builder.isEditing && r.lastHttpRequests[t4] === o3) return "continue";
              r.lastHttpRequests[t4] = o3, i3 ? r.handleRequest(t4, { url: o3, method: n3.request.method, body: n3.request.body, headers: n3.request.headers }) : r.handleRequest(t4, { url: o3, method: "GET" });
              var a3 = r.httpSubscriptionPerKey[t4];
              a3 && a3.unsubscribe();
              var s3 = r.httpSubscriptionPerKey[t4] = r.onStateChange.subscribe(function() {
                var e3 = i3 ? r.evalExpression(n3.request.url) : r.evalExpression(n3);
                e3 !== o3 && (i3 ? r.handleRequest(t4, { url: e3, method: n3.request.method, body: n3.request.body, headers: n3.request.headers }) : r.handleRequest(t4, { url: e3, method: "GET" }), r.lastHttpRequests[t4] = e3);
              });
              r.subscriptions.add(s3);
            } else i3 ? r.handleRequest(t4, { url: r.evalExpression(n3.request.url), method: n3.request.method, body: n3.request.body, headers: n3.request.headers }) : r.handleRequest(t4, { url: r.evalExpression(n3), method: "GET" });
          }
        };
    ...
    })), r.state = { context: __assign2(__assign2({}, t2.context), { apiKey: r.props.apiKey || builder.apiKey, nonce: r.props.nonce }), state: Object.assign(r.rootState, __assign2(__assign2(__assign2(__assign2({}, r.inlinedContent && r.inlinedContent.data && r.inlinedContent.data.state), { isBrowser: Builder.isBrowser, isServer: !Builder.isBrowser, _hydrate: t2.hydrate, location: r.locationState, deviceSize: r.deviceSizeState, device: r.device }), r.getHtmlData()), t2.data)), updates: 0, key: 0, update: r.updateState };
    var s = r.props.apiKey;
    if (s && s !== r.builder.apiKey && !instancesMap.has(s)) {
      var l = new Builder(s, void 0, void 0, true);
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "options", { get: function() {
    ...
    if (this.props.customComponents) for (var e2 = 0, t2 = this.props.customComponents; e2 < t2.length; e2++) {
      var n = t2[e2];
      if (n) {
        var i = n.component, r = __rest(n, ["component"]);
    ...
    })), Builder.isIframe && (null === (e2 = window.parent) || void 0 === e2 || e2.postMessage({ type: "builder.sdkInjected", data: { modelName: this.name, apiKey: this.props.apiKey || builder.apiKey } }, "*")), Builder.isBrowser && (window.addEventListener("resize", this.resizeListener), Builder.isEditing && window.addEventListener("message", this.messageListener), (Builder.isEditing || Builder.isPreviewing) && Builder.nextTick(function() {
    ...
    return (Builder.isServer || Builder.isBrowser && Builder.isPreviewing && !this.firstLoad) && (builder.previewingModel === this.name || "BUILDER_STUDIO" === builder.previewingModel);
  ...
  src: url('`).concat(s, "') format('woff2');\n  font-display: fallback;\n  font-weight: ").concat(a, ";\n}\n          ").trim());
    ...
    var e2, t2 = __assign2(__assign2(__assign2({}, this.inlinedContent && (null === (e2 = this.inlinedContent.data) || void 0 === e2 ? void 0 : e2.state)), this.externalState), this.state.state);
    ...
    this.props.data && e2.data !== this.props.data && this.state.update(function(e3) {
      Object.assign(e3, t2.externalState);
    }), this.props.customComponents && this.props.customComponents !== e2.customComponents && this.registerCustomComponents(), Builder.isEditing && this.inlinedContent && e2.content !== this.inlinedContent && this.onContentLoaded(this.inlinedContent.data, this.inlinedContent);
  ...
  }, enumerable: false, configurable: true }), Object.defineProperty(t.prototype, "externalState", { get: function() {
    return __assign2(__assign2({}, this.props.data), this.props.locale ? { locale: this.props.locale } : {});
    ...
    var e2, t2 = this, n = this.content, i = Builder.isBrowser && this.externalState && size$1(this.externalState) && (0, import_hash_sum2.default)(this.externalState), r = Builder.isEditing ? this.name : this.props.entry;
    ...
    return import_react3.default.createElement(o, { onClick: function(e3) {
      ...
      return import_react3.default.createElement(BuilderMetaContext.Provider, { value: "boolean" == typeof t2.props.ampMode ? __assign2(__assign2({}, e3), { ampMode: t2.props.ampMode }) : e3 }, import_react3.default.createElement(BuilderAsyncRequestsContext.Consumer, null, function(e4) {
        ...
        return t2._asyncRequests = e4 && e4.requests, t2._errors = e4 && e4.errors, t2._logs = e4 && e4.logs, import_react3.default.createElement(BuilderContent2, { isStatic: t2.props.isStatic || Builder.isStatic, key: (null === (i2 = t2.inlinedContent) || void 0 === i2 ? void 0 : i2.id) || ("content" in t2.props && !t2.isPreviewing ? "null-content-prop" : "no-content-prop"), builder: t2.builder, ref: function(e5) {
        ...
        }, options: __assign2(__assign2(__assign2(__assign2(__assign2(__assign2({ key: r, entry: t2.props.entry }, n && { initialContent: [n] }), !n && "content" in t2.props && !t2.isPreviewing && { initialContent: [] }), t2.props.url && { url: t2.props.url }), t2.props.options), t2.props.locale ? { locale: t2.props.locale } : {}), t2.options.codegen && { format: "react" }), inline: t2.props.inlineContent || !t2.isPreviewing && "content" in t2.props, contentError: t2.props.contentError, modelName: t2.name || "page", nonce: t2.props.nonce }, function(e5, n2, i3) {
          var r2;
          if (t2.props.dataOnly) return null;
          i3 && i3.id && (t2.state.breakpoints && (i3.meta = i3.meta || {}, i3.meta.breakpoints = t2.state.breakpoints), t2.state.context.builderContent = i3), Builder.isBrowser && Builder.nextTick(function() {
            t2.checkStyles(e5);
          });
          ...
          if (o2 && !t2.Component && (null == e5 ? void 0 : e5.blocksJs)) {
            ...
            t2.Component = new (Function.bind.apply(Function, __spreadArray(__spreadArray([void 0, "jsx", "_css", "Builder", "builder", "React", "useBuilderState"], u, false), [e5.blocksJs], false)))().apply(void 0, __spreadArray([jsx, css_browser_esm_default, Builder, builder, import_react3.default, function(e6) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      var n, i, r, o, a, s, l, u, d, c = this;
      return __generator(this, function(p) {
        return n = t2.url, i = t2.method, r = t2.body, o = t2.headers, a = JSON.stringify({ url: n, method: i, body: r, headers: o }), Builder.isIframe && fetchCache[a] ? (this.updateState(function(t3) {
          t3[e2] = fetchCache[a];
          ...
          return __awaiter(c, void 0, void 0, function() {
            ...
            return __generator(this, function(d2) {
              switch (d2.label) {
                case 0:
                  t3 = Date.now(), Builder.isBrowser || console.time("Fetch " + a), d2.label = 1;
                case 1:
                  return d2.trys.push([1, 4, 5, 6]), [4, fetch$1(n, { method: i, headers: o, body: r })];
                case 2:
                  return [4, d2.sent().json()];
                case 3:
                  return s2 = d2.sent(), [3, 6];
                case 4:
                  return l2 = d2.sent(), u2 = toError2(l2), this._errors && this._errors.push(u2), this._logs && this._logs.push("Fetch to ".concat(a, " errored in ").concat(Date.now() - t3, "ms")), [2];
                case 5:
                  return Builder.isBrowser || (console.timeEnd("Fetch " + a), this._logs && this._logs.push("Fetched ".concat(a, " in ").concat(Date.now() - t3, "ms"))), [7];
                case 6:
                  return s2 && (Builder.isIframe && (fetchCache[a] = s2), this.updateState(function(t4) {
                    t4[e2] = s2;
                  })), [2, s2];
              }
            });
          });
        }, (l = this._asyncRequests && this._asyncRequests.find(function(e3) {
          return isRequestInfo(e3) && e3.url === n;
        })) ? ((u = l.promise).then(function(t3) {
          t3 && c.updateState(function(n2) {
            n2[e2] = t3;
          });
        }), [2, u]) : (d = s(), Builder.nextTick(function() {
          c._asyncRequests && c._asyncRequests.push(d);
        }), [2, d]));
      });
    });
...
var withChildren = function(e) {
  var t = import_react3.default.forwardRef(function(t2, n) {
    var i, r, o = __assign2({}, t2), a = t2.children || t2.builderBlock && t2.builderBlock.children && t2.builderBlock.children.map(function(e2) {
      return import_react3.default.createElement(BuilderBlock$1, { key: e2.id, block: e2 });
    }), s = null === (r = null === (i = t2.builderBlock) || void 0 === i ? void 0 : i.component) || void 0 === r ? void 0 : r.options;
    return s && Object.keys(s).forEach(function(e2) {
      var t3 = s[e2];
      Array.isArray(t3) && t3.every(isBuilderElement) ? o[e2] = t3.map(function(e3) {
        return import_react3.default.createElement(BuilderBlock$1, { key: e3.id, block: e3 });
      }) : isBuilderElement(t3) && (o[e2] = import_react3.default.createElement(BuilderBlock$1, { block: t3 }));
    }), import_react3.default.createElement(e, __assign2({}, o, { ref: n }), a);
  });
...
var TextComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.componentDidMount = function() {
  ...
  }, t.prototype.evalExpression = function(e2, t2) {
    return this.allowTextEdit ? String(e2) : String(e2).replace(/{{([^}]+)}}/g, function(e3, n) {
      return tryEval(n, t2);
    });
    ...
    var e2 = this, t2 = { outline: "none", "& p:first-of-type, & .builder-paragraph:first-of-type": { margin: 0 }, "& > p, & .builder-paragraph": { color: "inherit", lineHeight: "inherit", letterSpacing: "inherit", fontWeight: "inherit", fontSize: "inherit", textAlign: "inherit", fontFamily: "inherit" } };
    return jsx(BuilderStoreContext.Consumer, null, function(n) {
      var i;
      return (null === (i = n.content.meta) || void 0 === i ? void 0 : i.rtlMode) && (t2.direction = "rtl"), jsx(import_react3.default.Fragment, null, jsx("span", __assign2({ ref: function(t3) {
        e2.textRef = t3;
      }, css: t2, className: "builder-text" }, { dangerouslySetInnerHTML: { __html: e2.evalExpression(e2.props.text || e2.props.content || "", n.state) } })));
    });
  }, t;
}(import_react3.default.Component);
...
var ColumnsComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "columns", { get: function() {
    ...
    var t2 = this.columns, n = this.gutterSize, i = this.getWidth(e2), r = n * (t2.length - 1) * (i / 100);
    return "calc(".concat(i, "% - ").concat(r, "px)");
  }, t.prototype.render = function() {
    var e2, t2, n, i, r = this, o = this.columns, a = this.gutterSize, s = (null === (i = null === (n = null === (t2 = this.props.builderState) || void 0 === t2 ? void 0 : t2.context.builderContent) || void 0 === n ? void 0 : n.meta) || void 0 === i ? void 0 : i.breakpoints) || {}, l = getSizesForBreakpoints(s);
    return jsx(import_react3.default.Fragment, null, jsx("div", { className: "builder-columns", css: __assign2({ display: "flex", height: "100%" }, "never" !== this.props.stackColumnsAt && (e2 = {}, e2["@media (max-width: ".concat("tablet" !== this.props.stackColumnsAt ? l.small.max : l.medium.max, "px)")] = { flexDirection: this.props.reverseColumnsWhenStacked ? "column-reverse" : "column", alignItems: "stretch" }, e2)) }, o.map(function(e3, t3) {
      var n2, i2, o2 = e3.link ? Link : "div";
      return jsx(import_react3.default.Fragment, { key: t3 }, jsx(o2, __assign2({ className: "builder-column" }, e3.link ? { href: e3.link } : null, { css: __assign2((n2 = { display: "flex", flexDirection: "column", alignItems: "stretch", lineHeight: "normal" }, n2["& > .builder-blocks"] = { flexGrow: 1 }, n2.width = r.getColumnWidth(t3), n2.marginLeft = 0 === t3 ? 0 : a, n2), "never" !== r.props.stackColumnsAt && (i2 = {}, i2["@media (max-width: ".concat("tablet" !== r.props.stackColumnsAt ? l.small.max : l.medium.max, "px)")] = { width: "100%", marginLeft: 0 }, i2)) }), jsx(BuilderBlocks, { key: t3, child: true, parentElementId: r.props.builderBlock && r.props.builderBlock.id, blocks: e3.blocks, dataPath: "component.options.columns.".concat(t3, ".blocks") })));
    })));
  }, t;
}(import_react3.default.Component);
...
var EmbedComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.shouldComponentUpdate = function(e2) {
    return e2.content !== this.props.content;
  }, t.prototype.componentDidUpdate = function(e2) {
...
var Embed = withBuilder(EmbedComponent, { name: "Embed", static: true, inputs: [{ name: "url", type: "url", required: true, defaultValue: "", helperText: "e.g. enter a youtube url, google map, etc" }, { name: "content", type: "html", defaultValue: '<div style="padding: 20px; text-align: center">(Choose an embed URL)<div>', hideFromUI: true }] });
...
var CustomCodeComponent = function(e) {
  ...
  }, Object.defineProperty(t.prototype, "noReactRender", { get: function() {
    var e2;
...
var getSizes = function(e, t, n) {
  ...
  if (e) {
    ...
    c = p.map(function(e2, t2) {
      return f === t2 + 1 ? e2.replace(/\([\s\S]*?\)/g, "").trim() : e2;
    }).join(", ");
  } else if (t && t.responsiveStyles) {
    var m = [], h = false, v = /^\d+/, g = getSizesForBreakpoints(n);
    if (null === (o = null === (r = null === (i = t.responsiveStyles) || void 0 === i ? void 0 : i.small) || void 0 === r ? void 0 : r.width) || void 0 === o ? void 0 : o.match(v)) {
      h = true;
      var b = "(max-width: ".concat(g.small.max, "px)"), y = "".concat(b, " ").concat(t.responsiveStyles.small.width.replace("%", "vw"));
      m.push(y);
    }
    if (null === (l = null === (s = null === (a = t.responsiveStyles) || void 0 === a ? void 0 : a.medium) || void 0 === s ? void 0 : s.width) || void 0 === l ? void 0 : l.match(v)) {
      h = true;
      b = "(max-width: ".concat(g.medium.max, "px)"), y = "".concat(b, " ").concat(t.responsiveStyles.medium.width.replace("%", "vw"));
      m.push(y);
    }
...
var ImageComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "useLazyLoading", { get: function() {
    ...
    var e2, t2, n = this, i = this.props, r = i.aspectRatio, o = i.lazy, a = i.builderBlock, s = i.builderState, l = this.props.builderBlock && this.props.builderBlock.children, u = this.props.srcset, d = getSizes(this.props.sizes, a, (null === (t2 = null === (e2 = null == s ? void 0 : s.context.builderContent) || void 0 === e2 ? void 0 : e2.meta) || void 0 === t2 ? void 0 : t2.breakpoints) || {}), c = this.image;
    ...
    return jsx(BuilderMetaContext.Consumer, null, function(e3) {
      var t3, i2 = e3.ampMode, a2 = i2 ? "amp-img" : "img", s2 = (!o || n.state.load || i2) && jsx(a2, __assign2({}, i2 ? { layout: "responsive", height: n.props.height || (r ? Math.round(1e3 * r) : void 0), width: n.props.width || (r ? Math.round(1e3 / r) : void 0) } : null, { alt: n.props.altText, title: n.props.title, key: Builder.isEditing && "string" == typeof n.image && n.image.split("?")[0] || void 0, role: n.props.altText ? void 0 : "presentation", css: __assign2(__assign2({ opacity: i2 ? 1 : n.useLazyLoading && !n.state.imageLoaded ? 0 : 1, transition: "opacity 0.2s ease-in-out", objectFit: n.props.backgroundSize || "cover", objectPosition: n.props.backgroundPosition || "center" }, r && !i2 && { position: "absolute", height: "100%", width: "100%", left: 0, top: 0 }), i2 && (t3 = {}, t3["& img"] = { objectFit: n.props.backgroundSize, objectPosition: n.props.backgroundPosition }, t3)), loading: p ? "eager" : "lazy", fetchPriority: p ? "high" : "auto", className: "builder-image" + (n.props.className ? " " + n.props.className : ""), src: n.image }, !i2 && { onLoad: function() {
        return n.setState({ imageLoaded: true });
      } }, { srcSet: u, sizes: !i2 && d ? d : void 0 }));
      return jsx(import_react3.default.Fragment, null, i2 ? s2 : jsx("picture", { ref: function(e4) {
        return n.pictureRef = e4;
      } }, u && u.match(/builder\.io/) && !n.props.noWebp && jsx("source", { srcSet: u.replace(/\?/g, "?format=webp&"), type: "image/webp" }), s2), !r || i2 || f && l && l.length ? null : jsx("div", { className: "builder-image-sizer", css: { width: "100%", paddingTop: 100 * r + "%", pointerEvents: "none", fontSize: 0 } }, " "), l && l.length ? f ? l.map(function(e4, t4) {
...
var Image = withBuilder(ImageComponent, { name: "Image", static: true, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4", defaultStyles: { position: "relative", minHeight: "20px", minWidth: "20px", overflow: "hidden" }, canHaveChildren: true, inputs: [{ name: "image", type: "file", bubble: true, allowedFileTypes: IMAGE_FILE_TYPES, required: true, defaultValue: "https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F72c80f114dc149019051b6852a9e3b7a", onChange: function(e) {
...
var VideoComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "lazyLoad", { get: function() {
    ...
    if (this.updateVideo(), this.lazyLoad && Builder.isBrowser) {
      var t2 = new IntersectionObserver(function(t3) {
        t3.forEach(function(t4) {
          t4.isIntersecting && (e2.setState(function(e3) {
            return __assign2(__assign2({}, e3), { load: true });
          }), e2.lazyVideoObserver && (e2.lazyVideoObserver.disconnect(), e2.lazyVideoObserver = null));
        });
      });
      this.containerRef && (t2.observe(this.containerRef), this.lazyVideoObserver = t2);
    }
  }, t.prototype.componentWillUnmount = function() {
    this.lazyVideoObserver && (this.lazyVideoObserver.disconnect(), this.lazyVideoObserver = null);
  }, t.prototype.render = function() {
    ...
    return jsx("div", { ref: function(t3) {
      ...
      return e2.video = t3;
    }, autoPlay: this.props.autoPlay, muted: this.props.muted, controls: this.props.controls, loop: this.props.loop, preload: this.props.preload || "metadata", className: "builder-video", css: __assign2({ width: "100%", height: "100%", objectFit: this.props.fit, objectPosition: this.props.position, borderRadius: 1 }, n ? { position: "absolute" } : null) }, (!this.lazyLoad || this.state.load) && jsx("source", { type: "video/mp4", src: this.props.video })), !n || this.props.fitContent && i ? null : jsx("div", { css: { width: "100%", paddingTop: 100 * n + "%", pointerEvents: "none", fontSize: 0 } }), i && this.props.fitContent ? jsx("div", { css: { display: "flex", flexDirection: "column", alignItems: "stretch" } }, i) : i ? jsx("div", { css: { pointerEvents: "none", display: "flex", flexDirection: "column", alignItems: "stretch", position: "absolute", top: 0, left: 0, width: "100%", height: "100%" } }, i) : null);
  }, t;
}(import_react3.default.Component);
var Video = Builder.registerComponent(withChildren(VideoComponent), { name: "Video", canHaveChildren: true, defaultStyles: { minHeight: "20px", minWidth: "20px" }, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-videocam-24px%20(1).svg?alt=media&token=49a84e4a-b20e-4977-a650-047f986874bb", inputs: [{ name: "video", type: "file", allowedFileTypes: VIDEO_FILE_TYPES, bubble: true, defaultValue: "https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fd27731a526464deba0016216f5f9e570%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&token=d27731a526464deba0016216f5f9e570&alt=media&optimized=true", required: true }, { name: "posterImage", type: "file", allowedFileTypes: IMAGE_FILE_TYPES, helperText: "Image to show before the video plays" }, { name: "autoPlay", type: "boolean", defaultValue: true }, { name: "controls", type: "boolean", defaultValue: false }, { name: "muted", type: "boolean", defaultValue: true }, { name: "loop", type: "boolean", defaultValue: true }, { name: "playsInline", type: "boolean", defaultValue: true }, { name: "fit", type: "text", defaultValue: "cover", enum: ["contain", "cover", "fill", "auto"] }, { name: "preload", type: "text", defaultValue: "metadata", enum: ["auto", "metadata", "none"] }, { name: "fitContent", type: "boolean", helperText: "When child blocks are provided, fit to them instead of using the aspect ratio", defaultValue: true, advanced: true }, { name: "position", type: "text", defaultValue: "center", enum: ["center", "top", "left", "right", "bottom", "top left", "top right", "bottom left", "bottom right"] }, { name: "height", type: "number", advanced: true }, { name: "width", type: "number", advanced: true }, { name: "aspectRatio", type: "number", advanced: true, defaultValue: DEFAULT_ASPECT_RATIO }, { name: "lazyLoad", type: "boolean", helperText: 'Load this video "lazily" - as in only when a user scrolls near the video. Recommended for optmized performance and bandwidth consumption', defaultValue: true, advanced: true }] });
...
var SymbolComponent = function(e) {
  function t() {
    var t2 = null !== e && e.apply(this, arguments) || this;
    return t2.ref = null, t2.staticRef = null, t2.isEditingThisSymbol = false, t2;
  }
  return __extends(t, e), Object.defineProperty(t.prototype, "placeholder", { get: function() {
    ...
    var e2, t2, n, i = this;
    this.useStatic && this.staticRef && refs[null === (e2 = this.props.builderBlock) || void 0 === e2 ? void 0 : e2.id] && (null === (t2 = this.staticRef.parentNode) || void 0 === t2 || t2.replaceChild(refs[null === (n = this.props.builderBlock) || void 0 === n ? void 0 : n.id], this.staticRef)), Builder.nextTick(function() {
      var e3 = i.props.symbol || {}, t3 = e3.model, n2 = e3.entry;
      i.isEditingThisSymbol = Boolean(Builder.isEditing && t3 === builder.editingModel && n2 && location.search.includes("overrides.".concat(n2)));
    });
    ...
    var i = this.props.symbol, r = false;
    i || (r = true);
    var o = this.props.dataOnly ? NoWrap : this.props.builderBlock && this.props.builderBlock.tagName || "div", a = i || {}, s = a.model, l = a.entry, u = a.data, d = a.content, c = a.inline, p = a.ownerId, f = (null == i ? void 0 : i.dynamic) || this.props.dynamic;
    s && (l || f) || (null === (e2 = null == d ? void 0 : d.data) || void 0 === e2 ? void 0 : e2.blocksJs) || c || (r = true), this.isEditingThisSymbol && (r = false);
    var m = f ? null === (t2 = this.props.builderBlock) || void 0 === t2 ? void 0 : t2.id : [s, l].join(":"), h = u && size2(u) && (0, import_hash_sum2.default)(u);
    ...
    return jsx(BuilderStoreContext.Consumer, { key: (s || "no model") + ":" + (l || "no entry" + this.isEditingThisSymbol) }, function(e3) {
      var t3, a2, c2, f2, h2, g, b, y, _, S, x, B = "".concat(m, "_").concat((null === (t3 = null == e3 ? void 0 : e3.state) || void 0 === t3 ? void 0 : t3.locale) || "Default");
      return jsx(o, __assign2({ "data-model": s }, v, { className: (v.class || v.className || "") + " builder-symbol" + ((null == i ? void 0 : i.inline) ? " builder-inline-symbol" : "") + ((null == i ? void 0 : i.dynamic) || n.props.dynamic ? " builder-dynamic-symbol" : "") }), r ? n.placeholder : jsx(BuilderComponent2, __assign2({}, p && { apiKey: p }, (null === (a2 = e3.state) || void 0 === a2 ? void 0 : a2.locale) && { locale: e3.state.locale }, { isChild: true, ref: function(e4) {
        return n.ref = e4;
      }, context: __assign2(__assign2({}, e3.context), { symbolId: null === (c2 = n.props.builderBlock) || void 0 === c2 ? void 0 : c2.id }), model: s, entry: l, data: __assign2(__assign2(__assign2({}, u), !!n.props.inheritState && omit$2(e3.state, "children")), null === (_ = null === (y = null === (b = null === (g = null === (h2 = null === (f2 = n.props.builderBlock) || void 0 === f2 ? void 0 : f2.component) || void 0 === h2 ? void 0 : h2.options) || void 0 === g ? void 0 : g.symbol) || void 0 === b ? void 0 : b.content) || void 0 === y ? void 0 : y.data) || void 0 === _ ? void 0 : _.state), renderLink: e3.renderLink, inlineContent: null == i ? void 0 : i.inline }, d && { content: d }, { key: B, options: __assign2(__assign2({}, !n.isEditingThisSymbol && { key: B, noEditorUpdates: true }), "content" === Builder.singletonInstance.apiEndpoint && l && { query: { id: l } }), codegen: !!(null === (S = null == d ? void 0 : d.data) || void 0 === S ? void 0 : S.blocksJs), hydrate: null === (x = e3.state) || void 0 === x ? void 0 : x._hydrate, builderBlock: n.props.builderBlock, dataOnly: n.props.dataOnly, nonce: e3.context.nonce }), n.props.children));
    });
  }, t;
}(import_react3.default.Component);
...
var RouterComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.route = function(e2) {
    ...
    return jsx(BuilderStoreContext.Consumer, null, function(n) {
      ...
      return jsx("div", { className: "builder-router", "data-model": t2 }, jsx("style", { nonce: n.context.nonce }, "\n                @keyframes builderLoadingSpinner {\n                  0% {\n                    transform: rotate(0deg);\n                  }\n                  100% {\n                    transform: rotate(360deg);\n                  }\n                }\n                /* TODO: overridable tag */\n                .builder-page-loading {\n                  -webkit-animation: builderLoadingSpinner 1s infinite linear;\n                  animation: builderLoadingSpinner 1s infinite linear;\n                  -webkit-transform: translateZ(0);\n                  transform: translateZ(0);\n                  border-radius: 50%;\n                  width: 36px;\n                  height: 36px;\n                  margin: 6px auto;\n                  position: relative;\n                  border: 1px solid transparent;\n                  border-left: 1px solid #808284;\n                }\n              "), jsx(BuilderComponent2, { key: i, data: e2.props.data, content: e2.routed ? void 0 : e2.props.content, modelName: t2, options: { key: Builder.isEditing ? void 0 : e2.model + ":" + i }, nonce: n.context.nonce }, e2.props.children || jsx("div", { css: { display: "flex" } }, jsx("div", { css: { margin: "40vh auto" }, className: "builder-page-loading" }))));
    });
...
var FormComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "submissionState", { get: function() {
    ...
    return jsx(BuilderStoreContext.Consumer, null, function(t2) {
      return jsx(BuilderStoreContext.Provider, { value: __assign2(__assign2({}, t2), { state: __assign2(__assign2({}, t2.state), { formErrorMessage: e2.state.formErrorMessage }) }) }, jsx("form", __assign2({}, e2.props.validate ? {} : { noValidate: true }, { ref: function(t3) {
        return e2.ref = t3;
        ...
        if ("zapier" === e2.props.sendSubmissionsTo) t3.preventDefault();
          ...
          var r = t3.currentTarget, o = e2.props.customHeaders || {}, a = void 0, s = new FormData(r), l = Array.from(t3.currentTarget.querySelectorAll("input,select,textarea")).filter(function(e3) {
            ...
            return !!e3.name && ("radio" !== e3.type || e3.checked);
          }).map(function(e3) {
            var t4, n2 = e3.name;
            if (e3 instanceof HTMLInputElement) if ("radio" === e3.type) {
              if (e3.checked) return { key: n2, value: t4 = e3.value };
...
var FormInputComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.render = function() {
    return import_react3.default.createElement("input", __assign2({ key: Builder.isEditing && this.props.defaultValue ? this.props.defaultValue : "default-key", placeholder: this.props.placeholder, type: this.props.type, name: this.props.name }, void 0 === this.props.value ? { defaultValue: this.props.defaultValue } : { value: this.props.value }, { required: this.props.required }, this.props.attributes));
  }, t;
}(import_react3.default.Component);
...
var FormSelectComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.render = function() {
    ...
    return import_react3.default.createElement("select", __assign2({ value: this.props.value, key: Builder.isEditing && this.props.defaultValue ? this.props.defaultValue : "default-key", defaultValue: this.props.defaultValue, name: this.props.name, required: this.props.required }, this.props.attributes), e2 && e2.map(function(e3) {
...
var TextAreaComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.render = function() {
    return import_react3.default.createElement("textarea", __assign2({ placeholder: this.props.placeholder, name: this.props.name, value: this.props.value, defaultValue: this.props.defaultValue, required: this.props.required }, this.props.attributes));
  }, t;
}(import_react3.default.Component);
...
var ImgComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.getSrcSet = function() {
    var e2 = this.props.image;
    if (e2 && "string" == typeof e2 && e2.match(/builder\.io/)) return getSrcSet(e2);
  }, t.prototype.render = function() {
    var e2 = this.props.attributes || {}, t2 = this.getSrcSet();
    return import_react3.default.createElement("img", __assign2({ loading: "lazy" }, this.props.attributes, { src: this.props.image || e2.src, srcSet: t2 }));
  }, t;
}(import_react3.default.Component);
var Img = withBuilder(ImgComponent, { name: "Raw:Img", hideFromInsertMenu: true, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4", inputs: [{ name: "image", bubble: true, type: "file", allowedFileTypes: IMAGE_FILE_TYPES, required: true }], noWrap: true, static: true });
...
Builder.registerComponent(RawText, { name: "Builder:RawText", hideFromInsertMenu: true, inputs: [{ name: "text", bubble: true, type: "longText", required: true }] });
...
function filterWithCustomTargeting(e, t, n, i) {
  var r = { query: t, startDate: n, endDate: i }, o = e.date && new Date(e.date) || /* @__PURE__ */ new Date();
  return !(r.startDate && new Date(r.startDate) > o) && (!(r.endDate && new Date(r.endDate) < o) && (!r.query || !r.query.length || r.query.every(function(t2) {
...
function objectMatchesQuery(e, t) {
  return function() {
    var n = t.property, i = t.operator, r = t.value;
    if (t && "urlPath" === t.property && t.value && "string" == typeof t.value && "/" !== t.value && t.value.endsWith("/") && (r = t.value.slice(0, -1)), !n || !i) return true;
    if (Array.isArray(r)) return "isNot" === i ? r.every(function(t2) {
      return objectMatchesQuery(e, { property: n, operator: i, value: t2 });
    }) : !!r.find(function(t2) {
      return objectMatchesQuery(e, { property: n, operator: i, value: t2 });
    });
    var o = e[n];
    if (Array.isArray(o)) return o.includes(r);
    switch (i) {
      case "is":
        return o === r;
      case "isNot":
        return o !== r;
      case "contains":
        return (isString(o) || Array.isArray(o)) && o.includes(String(r));
      case "startsWith":
        return isString(o) && o.startsWith(String(r));
      case "endsWith":
        return isString(o) && o.endsWith(String(r));
      case "greaterThan":
        return isNumber(o) && isNumber(r) && o > r;
      case "lessThan":
        return isNumber(o) && isNumber(r) && o < r;
...
function PersonalizationContainer(e) {
  var t, n, i, r, o, a, s, l, u, d, c, p, f, m, h, v, g, b, y, _, S, x = Boolean(Builder.isBrowser && (null === (t = window.__hydrated) || void 0 === t ? void 0 : t[null === (n = e.builderBlock) || void 0 === n ? void 0 : n.id])), B = (0, import_react3.useRef)(null), k = (0, import_react3.useState)(x), w = k[0], C = k[1], E = (0, import_react3.useState)(false), R = E[0], T = E[1], I = (0, import_react3.useState)(0);
  I[0];
  var j = I[1], O = (0, import_react3.useContext)(BuilderStoreContext);
  if ((0, import_react3.useEffect)(function() {
    var e2;
    C(true), T(true);
    var t2 = builder.userAttributesChanged.subscribe(function() {
      j(function(e3) {
        return e3 + 1;
      });
    }), n2 = [function() {
    ...
    if (!Builder.isEditing && !Builder.isPreviewing) {
      var i2 = P[0];
      null === (e2 = B.current) || void 0 === e2 || e2.dispatchEvent(new CustomEvent("builder.variantLoaded", { detail: { variant: i2 || "default", content: O.content }, bubbles: true }));
      var r2 = new IntersectionObserver(function(e3) {
        e3.forEach(function(e4) {
          var t3;
          e4.isIntersecting && (null === (t3 = B.current) || void 0 === t3 || t3.dispatchEvent(new CustomEvent("builder.variantDisplayed", { detail: { variant: i2 || "default", content: O.content }, bubbles: true })));
        });
      });
      r2.observe(B.current), n2.push(function() {
        return r2.disconnect();
      });
    }
    return function() {
  ...
  }, []), Builder.isServer) return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", __assign2({}, e.attributes, { style: __assign2({ opacity: 1, transition: "opacity 0.2s ease-in-out" }, null === (i = e.attributes) || void 0 === i ? void 0 : i.style), className: "builder-personalization-container ".concat(e.attributes.className) }), null === (r = e.variants) || void 0 === r ? void 0 : r.map(function(t2, n2) {
    var i2, r2;
    return import_react3.default.createElement("template", { key: n2, "data-variant-id": (null === (i2 = e.builderBlock) || void 0 === i2 ? void 0 : i2.id) + n2 }, import_react3.default.createElement(BuilderBlocks, { blocks: t2.blocks, parentElementId: null === (r2 = e.builderBlock) || void 0 === r2 ? void 0 : r2.id, dataPath: "component.options.variants.".concat(n2, ".blocks"), child: true }));
  }), import_react3.default.createElement("script", { nonce: O.context.nonce, id: "variants-script-".concat(null === (o = e.builderBlock) || void 0 === o ? void 0 : o.id), dangerouslySetInnerHTML: { __html: getPersonalizationScript(e.variants, (null === (a = e.builderBlock) || void 0 === a ? void 0 : a.id) || "none", null === (s = e.builderState.state) || void 0 === s ? void 0 : s.locale) } }), import_react3.default.createElement(BuilderBlocks, { blocks: null === (l = e.builderBlock) || void 0 === l ? void 0 : l.children, parentElementId: null === (u = e.builderBlock) || void 0 === u ? void 0 : u.id, dataPath: "this.children", child: true })), import_react3.default.createElement("script", { nonce: O.context.nonce, dangerouslySetInnerHTML: { __html: "\n         window.__hydrated = window.__hydrated || {};\n         window.__hydrated['".concat(null === (d = e.builderBlock) || void 0 === d ? void 0 : d.id, "'] = true;\n        ").replace(/\s+/g, " ") } }));
  var P = (e.variants || []).filter(function(t2) {
    var n2;
    return filterWithCustomTargeting(__assign2(__assign2({}, (null === (n2 = e.builderState.state) || void 0 === n2 ? void 0 : n2.locale) ? { locale: e.builderState.state.locale } : {}), builder.getUserAttributes()), t2.query, t2.startDate, t2.endDate);
  });
  return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", __assign2({ ref: B }, e.attributes, { style: __assign2({ opacity: w ? 1 : 0, transition: "opacity 0.2s ease-in-out" }, null === (c = e.attributes) || void 0 === c ? void 0 : c.style), className: "builder-personalization-container ".concat(e.attributes.className).concat(w ? "" : " builder-personalization-container-loading") }), R && Builder.isEditing && "number" == typeof e.previewingIndex && e.previewingIndex < ((null === (p = e.variants) || void 0 === p ? void 0 : p.length) || 0) ? import_react3.default.createElement(BuilderBlocks, { blocks: null === (m = null === (f = e.variants) || void 0 === f ? void 0 : f[e.previewingIndex]) || void 0 === m ? void 0 : m.blocks, parentElementId: null === (h = e.builderBlock) || void 0 === h ? void 0 : h.id, dataPath: "component.options.variants.".concat(e.previewingIndex, ".blocks"), child: true }) : R && Builder.isEditing && "number" != typeof e.previewingIndex || !w || !P.length ? import_react3.default.createElement(BuilderBlocks, { blocks: null === (v = e.builderBlock) || void 0 === v ? void 0 : v.children, parentElementId: null === (g = e.builderBlock) || void 0 === g ? void 0 : g.id, dataPath: "this.children", child: true }) : import_react3.default.createElement(BuilderBlocks, { blocks: null === (b = P[0]) || void 0 === b ? void 0 : b.blocks, parentElementId: null === (y = e.builderBlock) || void 0 === y ? void 0 : y.id, dataPath: "component.options.variants.".concat(null === (_ = e.variants) || void 0 === _ ? void 0 : _.indexOf(P[0]), ".blocks"), child: true })), import_react3.default.createElement("script", { nonce: O.context.nonce, dangerouslySetInnerHTML: { __html: "\n         window.__hydrated = window.__hydrated || {};\n         window.__hydrated['".concat(null === (S = e.builderBlock) || void 0 === S ? void 0 : S.id, "'] = true;\n        ").replace(/\s+/g, " ") } }));
}
function getPersonalizationScript(e, t, n) {
  return `
      (function() {
        ...
        var attributes = JSON.parse(getCookie("`).concat(Builder.attributesCookieName, '") || "{}");\n        ').concat(n ? 'attributes.locale = "'.concat(n, '";') : "", "\n        var variants = ").concat(JSON.stringify(null == e ? void 0 : e.map(function(e2) {
    return { query: e2.query, startDate: e2.startDate, endDate: e2.endDate };
  })), `;
