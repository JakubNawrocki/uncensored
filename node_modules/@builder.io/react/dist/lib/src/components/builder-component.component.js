...
var BuilderComponent = /** @class */ (function (_super) {
    ...
    function BuilderComponent(props) {
            ...
            if (data && data.httpRequests /* || data.builderData @DEPRECATED */ && !_this.props.noAsync) {
                ...
                if (!skip) {
                    var _loop_1 = function (key) {
                        var httpRequest = data.httpRequests[key];
                        if (httpRequest && (!_this.data[key] || sdk_1.Builder.isEditing)) {
                            var isCoreRequest_1 = typeof httpRequest === 'object' &&
                                httpRequest['@type'] === '@builder.io/core:Request';
                            if (sdk_1.Builder.isBrowser) {
                                var finalUrl_1 = isCoreRequest_1
                                    ? _this.evalExpression(httpRequest.request.url)
                                    : _this.evalExpression(httpRequest);
                                if (sdk_1.Builder.isEditing && _this.lastHttpRequests[key] === finalUrl_1) {
                                    return "continue";
                                }
                                _this.lastHttpRequests[key] = finalUrl_1;
                                if (isCoreRequest_1) {
                                    _this.handleRequest(key, {
                                        url: finalUrl_1,
                                ...
                                if (isCoreRequest_1) {
                                    _this.handleRequest(key, {
                                        url: _this.evalExpression(httpRequest.request.url),
                                        method: httpRequest.request.method,
                                        body: httpRequest.request.body,
                                        headers: httpRequest.request.headers,
                                    });
                                    ...
                                    _this.handleRequest(key, {
                                        url: _this.evalExpression(httpRequest),
                                        method: 'GET',
                                    });
                                }
                            }
        ...
        _this.state = {
            ...
            context: __assign(__assign({}, props.context), { apiKey: _this.props.apiKey || sdk_1.builder.apiKey, nonce: _this.props.nonce }),
    ...
    BuilderComponent.prototype.componentDidMount = function () {
        ...
        if (sdk_1.Builder.isIframe) {
            (_a = window.parent) === null || _a === void 0 ? void 0 : _a.postMessage({
                ...
                data: { modelName: this.name, apiKey: this.props.apiKey || sdk_1.builder.apiKey },
            }, '*');
        }
        if (sdk_1.Builder.isBrowser) {
                ...
                react_1.default.createElement(builder_async_requests_1.BuilderAsyncRequestsContext.Consumer, null, function (value) {
                    ...
                    return (react_1.default.createElement(builder_content_component_1.BuilderContent, { isStatic: _this.props.isStatic || sdk_1.Builder.isStatic, key: ((_a = _this.inlinedContent) === null || _a === void 0 ? void 0 : _a.id) ||
                        ...
                        contentLoaded: function (data, content) { return _this.onContentLoaded(data, content); }, options: __assign(__assign(__assign(__assign(__assign(__assign({ key: key, entry: _this.props.entry }, (content && { initialContent: [content] })), (!content &&
                            ...
                            format: 'react',
                        })), inline: _this.props.inlineContent || (!_this.isPreviewing && 'content' in _this.props), contentError: _this.props.contentError, modelName: _this.name || 'page', nonce: _this.props.nonce }, function (data, loading, fullData) {
                        var _a;
                        ...
                        return data ? (react_1.default.createElement("div", __assign({ "data-builder-component": _this.name, "data-builder-content-id": fullData.id }, (_this.isPreviewing
                            ...
                            : {})),
                            !codegen && _this.getCss(data) && (react_1.default.createElement("style", { nonce: _this.props.nonce, ref: function (ref) { return (_this.styleRef = ref); }, className: "builder-custom-styles", dangerouslySetInnerHTML: {
    ...
    BuilderComponent.prototype.handleRequest = function (propertyName, httpRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var url, method, body, headers, fetchCacheKey, request, existing, promise_1, promise;
            var _this = this;
            return __generator(this, function (_a) {
                url = httpRequest.url, method = httpRequest.method, body = httpRequest.body, headers = httpRequest.headers;
                fetchCacheKey = JSON.stringify({ url: url, method: method, body: body, headers: headers });
                // TODO: Builder.isEditing = just checks if iframe and parent page is this.builder.io or localhost:1234
                if (sdk_1.Builder.isIframe && fetchCache[fetchCacheKey]) {
                    this.updateState(function (ctx) {
                        ctx[propertyName] = fetchCache[fetchCacheKey];
                    });
                    return [2 /*return*/, fetchCache[fetchCacheKey]];
                }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 4:
                                ...
                                if (this._logs) {
                                    this._logs.push("Fetch to ".concat(fetchCacheKey, " errored in ").concat(Date.now() - requestStart, "ms"));
                                }
                                return [2 /*return*/];
                            case 5:
                                if (!sdk_1.Builder.isBrowser) {
                                    ...
                                    if (this._logs) {
                                        this._logs.push("Fetched ".concat(fetchCacheKey, " in ").concat(Date.now() - requestStart, "ms"));
                                    }
                                }
                                return [7 /*endfinally*/];
                            case 6:
